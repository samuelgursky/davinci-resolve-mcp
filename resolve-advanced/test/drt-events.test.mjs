...
test('drtEventsFromParsed walks one timeline into sequence-relative events with transitions, flags and lanes (E139)', async () => {
  ...
  assert.equal(frozen.srcIn, 0, 'a flat map holds the frozen source second (0) — the <In> is ignored by Resolve (E144, render-witnessed)');
  assert.equal(frozen.recordDomainIn, 86400);
...
// ── E144: Resolve-written (keyed-dict) time maps — verbatim harvest blobs from live 19.1.3.7 ──
const HARVEST = {
  // XMEML import of a 100% clip (E66): Resolve stamped a FLAT map at Y=0 over the 60000 sentinel with In 24 —
  // and its render is static at the source's frame 0 (inter-frame change 0.02 vs 0.42 in the source).
  e66: { in: '24', dur: 48, tm: '' },
  // a 50% constant retime written by Resolve (E53): keyed-dict keyframes (0,0) → (15.958, 7.979)
  e53: { in: '0|0000000000000000', dur: 48, tm: '' },
  // a speed RAMP (E64): origin (0, 4.0 s) then (1, 4.5) and (2, 6.5) — 50% for a second, then 200%
  e64: { in: '0|0000000000000000', dur: 48, tm: '' },
  // an EDL M2 000.0 freeze (E55): flat at Y = 1.0 s with an EMPTY <In>
  e55: { in: '', dur: 48, tm: '' },
};

function harvestDrt() {
  const items = [
    vclip('h1', 'cut_src.mp4', 172608, HARVEST.e66.dur, HARVEST.e66.in, '/Volumes/X/cut_src.mp4', HARVEST.e66.tm),
    vclip('h2', 'cut_src.mp4', 172656, HARVEST.e53.dur, HARVEST.e53.in, '/Volumes/X/cut_src.mp4', HARVEST.e53.tm),
    vclip('h3', 'cut_src.mp4', 172704, HARVEST.e64.dur, HARVEST.e64.in, '/Volumes/X/cut_src.mp4', HARVEST.e64.tm),
    vclip('h4', 'cut_src.mp4', 172752, HARVEST.e55.dur, HARVEST.e55.in, '/Volumes/X/cut_src.mp4', HARVEST.e55.tm),
  ].join('');
  const container = `<?xml version="1.0" encoding="UTF-8"?>
<Sm2SequenceContainer DbId="c2"><FieldsBlob/><VideoTrackVec>${track('t9', 0, items)}</VideoTrackVec><AudioTrackVec/></Sm2SequenceContainer>`;
  const zip = new JSZip();
  zip.file('project.xml', '<?xml version="1.0" encoding="UTF-8"?><SyProject DbId="p2"><Name>HARVEST</Name></SyProject>');
  zip.file('SeqContainer/96337e43-1eae-4901-a1b9-a8961094021b.xml', container);
  zip.file('MediaPool/Master/MpFolder.xml', MP_FOLDER);
  return zip.generateAsync({ type: 'nodebuffer' });
}

test('Resolve-written keyed-dict time maps decode: 50% constant, a ramp with a non-zero origin, and both freezes (E144)', async () => {
  const parsed = await parseDRT(await harvestDrt());
  const clips = parsed.timelines[0].videoTracks[0].clips;
  assert.deepEqual(clips.map((c) => [c.timemap.kind, c.timemap.keyframeForm, c.timemap.speed]), [
    ['freeze', 'keyed', 0], ['constant', 'keyed', 0.5], ['variable', 'keyed', 0.5], ['freeze', 'keyed', 0],
  ]);
  assert.equal(clips[0].timemap.freezeSec, 0);
  assert.equal(clips[3].timemap.freezeSec, 1);
  assert.deepEqual(clips[2].timemap.points.map((p) => [p.recordSec, p.sourceSec]), [[0, 4], [1, 4.5], [2, 6.5]]);
  const ev = drtEventsFromParsed(parsed).events;
  assert.deepEqual(ev.map((e) => [e.srcIn, e.srcOut, e.speed, e.variableSpeed || false, e.recordDomainIn ?? null]), [
    [0, 0, 0, false, 24],       // E66: frozen at source frame 0 although <In> says 24 — what the render shows
    [0, 24, 50, false, null],   // E53: 48 record frames at 50% = 24 source frames from 0
    [96, 156, 50, true, 0],     // E64: origin 4.0 s = frame 96; 24 f at 0.5 + 24 f at 2.0 = 60 source frames; In was written (0)
    [24, 24, 0, false, null],   // E55: frozen at 1.0 s = frame 24, <In> empty
  ]);
  assert.deepEqual(ev[2].retimeSegments.map((sg) => sg.speed), [0.5, 2]);
});
