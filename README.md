...
[![Version](https://img.shields.io/badge/version-2.219.0-blue.svg)](https://github.com/samuelgursky/davinci-resolve-mcp/releases)
[![npm](https://img.shields.io/npm/v/davinci-resolve-mcp.svg?label=npm&color=CB3837)](https://www.npmjs.com/package/davinci-resolve-mcp)
[![API Coverage](https://img.shields.io/badge/API%20Coverage-100%25-brightgreen.svg)](docs/reference/api-coverage.md)
[![Tools](https://img.shields.io/badge/MCP%20Tools-36%20(371%20full)-blue.svg)](#server-modes)
...
| Full / granular | `src/server.py --full` or `src/resolve_mcp_server.py` | 371 | Power users who want one MCP tool per Resolve API method. |
...
| Metric | Value |
|--------|-------|
| MCP Tools | **36** compound / **371** granular (live server) |
