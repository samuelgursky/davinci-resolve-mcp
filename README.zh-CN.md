...
[![Tools](https://img.shields.io/badge/MCP%20Tools-36%20(371%20full)-blue.svg)](#服务器模式)
...
| Full / granular（细粒度） | `src/server.py --full` 或 `src/resolve_mcp_server.py` | 371 | 想要"一个 Resolve API 方法 = 一个 MCP 工具"的重度用户。 |
