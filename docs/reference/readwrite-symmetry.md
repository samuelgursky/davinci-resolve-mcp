...
- write-style actions scanned: **116**
- with a matching read: **67**
- high-signal `set_` actions without a direct/known readback: **8**
...
## Low-signal (create/add/insert/import — usually expected): 40
