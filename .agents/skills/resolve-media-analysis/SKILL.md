...
This skill wraps the project's canonical media analysis guide with host-agent integration.

**Read `docs/guides/media-analysis-guide.md` for the complete guide.** Everything below is host-agent integration context.
