...
- **Craft / story** — `docs/guides/editorial-decision-guide.md`. If the host
  provides additional editorial craft guidance, use it for *why to cut*, not as
  a replacement for tool mechanics.
