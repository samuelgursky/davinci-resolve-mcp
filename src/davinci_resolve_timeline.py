...
def mcp_create_timeline(timeline_name: str, resolution: Optional[Dict[str, str]] = None, 
                      frame_rate: Optional[float] = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if timeline:
            ...
            if found:
                ...
                return {"error": f"Timeline was created but could not be found by name: '{timeline_name}'"}
        else:
...
def mcp_delete_timeline(timeline_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        current_timeline_is_target = (current_timeline and current_timeline.GetName() == timeline_name)
            ...
            if new_timeline:
                ...
                try:
                    ...
                    if new_timeline:
                        ...
                        return {"error": f"Failed to duplicate timeline '{timeline_name}'"}
                except Exception as e:
        ...
        for i in range(1, timeline_count + 1):
            ...
            if timeline.GetName() == timeline_name:
                ...
                if success:
                    ...
                    return {"error": f"Failed to set timeline '{timeline_name}' as current"}
...
def mcp_add_timeline_marker(frame_position: int, color: str = "Blue", name: str = "", 
                          note: str = "", duration: int = 1) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        # Add the marker
        marker_id = current_timeline.AddMarker(frame_position, color, name, note, duration)
...
def mcp_export_timeline(timeline_name: Optional[str] = None, 
                       file_path: str = "", 
                       export_type: str = "fcpxml") -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if export_type not in valid_export_types:
            return {"error": f"Invalid export type. Choose from: {', '.join(valid_export_types)}"}
        ...
        try:
            ...
            if success:
                ...
                return {"error": f"Failed to export timeline '{timeline_name}' as {export_type}"}
        except Exception as e:
