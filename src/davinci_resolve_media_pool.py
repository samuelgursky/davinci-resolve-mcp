...
def mcp_create_media_pool_folder(folder_name: str, parent_folder_name: Optional[str] = None) -> Dict[str, Any]:
    """
...
def mcp_import_media(file_paths: List[str], folder_name: Optional[str] = None) -> Dict[str, Any]:
    """
...
def mcp_set_clip_property(clip_name: str, property_name: str, property_value: Any) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if success:
            ...
            return {"error": f"Failed to update property '{property_name}' for clip '{clip_name}'"}
