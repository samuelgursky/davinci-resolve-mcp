---
name: cut-reviewer
description: Reviews an assembled Resolve timeline by looking at its frames — pacing, shot order, continuity, and coverage gaps. Use after building or restructuring a cut, before showing it to the user. Reads frames as images, so run it as a subagent to keep them out of the main context.
tools: Read, Glob, Grep, Bash, mcp__davinci-resolve__timeline, mcp__davinci-resolve__timeline_item, mcp__davinci-resolve__media_analysis, mcp__davinci-resolve__timeline_markers, mcp__davinci-resolve__media_pool_item
model: opus
---
